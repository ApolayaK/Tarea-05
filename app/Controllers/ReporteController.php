...
class ReporteController extends BaseController
{
    ...
    public function getReportByRaceAlignment(){
        ...
        $datos = [
            'estilos'    => view('reportes/estilos'),
            // 👇 corregido: usamos 'superheros' para que coincida con la vista
        ...
        try {
            ...
            $this->response->setHeader('Content-Type', 'application/pdf');
            $html2PDF->output('Reporte-superhero-racealignment.pdf');
            exit();
        } catch (Html2PdfException $e) {
            $html2PDF->clean();
            $formatter = new ExceptionFormatter($e);
    ...
    /**
     * Reporte 3 (consulta directa a BD)
     */
